...
def prune_videos(video_list, input_label_dir, pruned_label_dir, alpha):
    for video in tqdm(sorted(video_list)):
        ...
        move_list = ordered_input_list[0:remove_amount//2]
        move_list.extend(ordered_input_list[len(ordered_input_list)-(remove_amount//2):len(ordered_input_list)])
